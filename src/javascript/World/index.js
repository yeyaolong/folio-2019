...
export default class
{
    ...
    setStartingScreen()
    {
        ...
        this.startingScreen.area = this.areas.add({
            position: new THREE.Vector2(0, 0),  // 起点
        ...
        this.startingScreen.loadingLabel.texture = new THREE.Texture(this.startingScreen.loadingLabel.image) // 纹理
